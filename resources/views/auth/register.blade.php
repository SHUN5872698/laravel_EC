                        ...
                        <form method="POST" action="{{ route('register') }}">
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-md-6 mt-2">
                                    <input id="name" type="text" class="form-control @error('name') is-invalid @enderror" maxlength="30"
                                    name="name" value="{{ old('name') }}" placeholder="４文字以上30文字以内"
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-md-6">
                                    <input id="password" type="password"
                                        class="form-control @error('password') is-invalid @enderror" name="password" maxlength="30" placeholder="8文字以上３０文字以内"
                            ...
                            <div class="form-group row">
                                <label for="password-confirm"
                                    class="col-md-4 col-form-label text-md-right">{{ __('Confirm Password') }}　<font color="red">必須</font></label>
                            ...
                            <div class="form-group row mb-0">
                                <div class="col-md-6 offset-md-4">
                                    ...
                                    <button type="button" class="btn btn-outline-primary"
                                        onclick="location.href='/main';">キャンセル</button>
                                </div>
                            </div>
                        </form>
                    </div>
